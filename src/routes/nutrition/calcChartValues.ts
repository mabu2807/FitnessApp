		...
		for (let j = 0; j < responseUsermeals.length; j++) {
			if (responseUsermeals[j].day.getDay() === i) {
				if (responseUsermeals[j].dish || responseUsermeals[j].customDish) {
					calperdayunsorted[i] =
						calperdayunsorted[i] +
						(responseUsermeals[j].dish?.nutritionalValues.energy ??
							responseUsermeals[j].customDish?.nutritionalValues.energy ??
							0);
					saltperdayunsorted[i] =
						saltperdayunsorted[i] +
						(responseUsermeals[j].dish?.nutritionalValues.salt ??
							responseUsermeals[j].customDish?.nutritionalValues.salt ??
							0);
					sugarperdayunsorted[i] =
						sugarperdayunsorted[i] +
						(responseUsermeals[j].dish?.nutritionalValues.sugar ??
							responseUsermeals[j].customDish?.nutritionalValues.sugar ??
							0);
					saturatedFatperdayunsorted[i] =
						saturatedFatperdayunsorted[i] +
						(responseUsermeals[j].dish?.nutritionalValues.saturatedFat ??
							responseUsermeals[j].customDish?.nutritionalValues.saturatedFat ??
							0);
					carbohydratesperdayunsorted[i] =
						carbohydratesperdayunsorted[i] +
						(responseUsermeals[j].dish?.nutritionalValues.carbohydrates ??
							responseUsermeals[j].customDish?.nutritionalValues.carbohydrates ??
							0);
					fatperdayunsorted[i] =
						fatperdayunsorted[i] +
						(responseUsermeals[j].dish?.nutritionalValues.fat ??
							responseUsermeals[j].customDish?.nutritionalValues.fat ??
							0);
					proteinperdayunsorted[i] =
						proteinperdayunsorted[i] +
						(responseUsermeals[j].dish?.nutritionalValues.protein ??
							responseUsermeals[j].customDish?.nutritionalValues.protein ??
							0);
				}
			}
		}
