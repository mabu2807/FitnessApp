...
<section class="flex items-center justify-center mt-32 mb-28 h-full dark:bg-surface-800">
	<div class="lg:w-3/4 w-5/6 sm:flex my-20 ">
		...
		<div
			class="sm:w-1/2 w-full flex flex-col justify-center items-center  dark:bg-gradient-to-b dark:from-surface-500 dark:from-10% dark:via-sky-700 dark:via-31% dark:to-surface-500 dark:to-80%  sm:rounded-tr-xl sm:rounded-br-xl sm:rounded-bl-none rounded-bl-xl rounded-br-xl"
		>
