	...
	<div class="card w-3/4 m-10 shadow-xl sm:p-8 p-4 items-center bottom-gradient">
		...
		<Step class="text-center">
			<svelte:fragment slot="header"
				><h4 class="h4 mt-10">In welcher Sportart möchtest du deinen asozialen Fortschritt tracken?</h4></svelte:fragment
			>
			<Chooser />
		</Step>
			<Step class="text-center">
				<svelte:fragment slot="header"
					><h4 class="h4 mt-10">Tracke deine Aktivitäten im Bereich {$selectedCategory}!</h4></svelte:fragment
				>
